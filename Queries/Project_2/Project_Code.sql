...
/* Generating new email addresses for each employee.
  - The email is formed by:
    a. Replacing spaces in 'employee_name' with periods (.),
    b. Converting the result to lowercase,
    c. Appending '@ndogowater.gov' to create a standardized company email address.
  - The result is shown as a column called 'New_Email' for review before updating the table */
SELECT
...
/*-- Getting the employee_ids and use them to get the names, email and phone numbers
	of the three field surveyors with the most location visits. --*/
...
-- ANALYSING LOCATION --
/* We are looking at some of the tables in the dataset at a larger scale,
	identify some trends, summarise important data, and draw insights.--*/
